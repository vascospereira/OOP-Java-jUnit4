...
public class TestCases {
	...
	public void testCapacity() throws Exception {
		...
		assertEquals(52, b208.getCapacity());
		Room b213 = new Room(b, "213", 2, 52);
		assertEquals(52, b213.getCapacity());
	...
	public void testDuplicateRooms() throws Exception {
		Building b = new Building("B", -1, 4);
		Building bb = new Building("BB", -1, 16);
		Room r1 = new Room(b, "104", 1);
		Room r2 = new Room(b, "104", 1);
		Room r3 = new Room(bb, "104", 2);
		Room r4 = new Room(bb, "104", 1);
	}
